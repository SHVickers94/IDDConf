# Getting help with IDDConf

Thanks for using IDDConf!
...
*   If it's a bug: you're in the right place, [file an issue](https://github.com/SHVickers94/IDDConf/issues/new).  
  
*   If you're not sure: let the community help you figure it out! 
    If your problem _is_ a bug or a feature request, you can easily return here and report it. 

Before opening a new issue, be sure to [search issues and pull requests](https://github.com/SHVickers94/IDDConf/issues) to make sure the bug hasn't been reported and/or already fixed in the development version. 
